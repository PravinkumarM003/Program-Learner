export default function Login() {
  const authUrl = import.meta.env.VITE_AUTH_URL || 'http://localhost:4000/api/auth/google'
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12"
        ...
        <div className="w-full max-w-sm animate-fade-up">
          ...
          <div className="glass-card rounded-3xl p-8 text-center" style={{ boxShadow: '0 24px 64px rgba(0,0,0,0.4)' }}>
            ...
            {/* Google sign-in */}
            <a href={authUrl}
              className="flex items-center justify-center gap-3 w-full rounded-2xl px-6 py-3.5 font-semibold text-slate-900 transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
              style={{ background: '#ffffff', boxShadow: '0 2px 12px rgba(0,0,0,0.2)' }}>
